...
namespace EasyBlockchain\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('EasyBlockchain', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/EasyBlockchain/blockchain.log',
    ...
    protected function createSlackDriver(array $config)
    {
        return new Monolog($this->parseChannel($config), [
            $this->prepareHandler(new SlackWebhookHandler(
                $config['url'],
                $config['channel'] ?? null,
                $config['username'] ?? 'EasyBlockchain',
    ...
    {
        return $config['name'] ?? 'EasyBlockchain';
    }
